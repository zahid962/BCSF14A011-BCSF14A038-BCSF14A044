...
public class TicTacTue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tic_tac_tue);
    ...
    {
        AlertDialog.Builder adb=new AlertDialog.Builder(TicTacTue.this);
        adb
